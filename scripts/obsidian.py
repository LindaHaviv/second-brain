"""Collect step (Obsidian / any markdown vault): local .md notes -> the brain.
...
import db                      # noqa: E402
from content import note_chunks  # noqa: E402
...
def main():
    ...
    new = updated = unchanged = private = 0
    for path in vault_notes(vault):
        ...
        if visibility == "content":
            for i, ch in enumerate(note_chunks(body)):
                cur.execute(
