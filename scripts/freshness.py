...
RULES = {
    ...
    "tiktok":      ("auto",    9, "weekly Apify self-scrape may not be running - check sync log / Apify credit"),
    "x":           ("auto",    9, "weekly Apify self-scrape may not be running - check sync log / Apify credit"),
